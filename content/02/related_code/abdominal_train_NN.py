...
if __name__ == '__main__':
    ...
    # df = pd.read_pickle('./data/abdominal_data.pkl')
    ...
    for epoch in range(hp.num_epochs): 
      ...
      if running_loss < best:
        ...
        if num_bad_epochs == hp.patience:
          # torch.save(final_model, hp.logdir + 'abdominal/final_model.pt')
          torch.save(final_model, hp.logdir + 'abdominal/final_model_3T.pt')
