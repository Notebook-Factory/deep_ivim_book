...
if __name__ == '__main__':
  # df = pd.read_pickle('./data/abdominal_data_.pkl')
  df = pd.read_pickle('./data/abdominal_data_3T.pkl')
  ...
  # df.to_pickle('./data/abdominal_data_LS.pkl')
  # df.to_csv('./data/abdominal_data_LS.csv', index=False)
  df.to_pickle('./data/abdominal_data_LS_3T.pkl')
  df.to_csv('./data/abdominal_data_LS_3T.csv', index=False)
