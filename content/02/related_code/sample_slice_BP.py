...
if __name__ == '__main__':
  # df = pd.read_pickle('./data/sample_slice_LS.pkl')
  df = pd.read_pickle('./data/sample_slice_LS_3T.pkl')
  ...
  # df.to_pickle('./data/sample_slice_LS_BP.pkl')
  # df.to_csv('./data/sample_slice_LS_BP.csv', index=False)
  df.to_pickle('./data/sample_slice_LS_BP_3T.pkl')
  df.to_csv('./data/sample_slice_LS_BP_3T.csv', index=False)
